...
comment1 = Comment.new(post: posts[0], user: users[1], description: 'I am agree with you my friend. The system is not efficent', inappropiate_counter: 0, inappropiate_comment: inappropiate_c1)
