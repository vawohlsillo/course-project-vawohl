...
super_admin = User.new( name: "Vicente Wohl", biography: "SuperAdmin at Filch App in Santiago,Chile Geofence", sex: "Man", role: "SuperAdmin", email: "vawohl@miuandes.cl", password: "password123", image: File.new("app/assets/images/vicho.png","r"))
...
post1 = Post.new(user: @users[1], title: 'Transportation in San Carlos it is very bad', description: 'When I came back to home from university, it is a hole mess because transantiago buses are full from its capacity so it takes one hour to get tu Los Dominicos Subway',  solve_status: 0, inappropiate_counter: 0)
